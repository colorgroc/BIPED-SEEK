...
public class Tutorial_InGame : MonoBehaviour {
    [SerializeField]
    private GameObject welcome, score, abilities, feedback, icon, rounds_time, objectiveTuto, welcome1, welcome2, thereUR, objetive, player1, player2, HUD, box, objectiveCanvas, goKill, goKill2, guards, score2, score3, winner, finnish, events, mapEvent;
    public Text titol;
    bool once, _once, _Once, __Once;
